...
const Services = () => {
    return (
        <>
            ...
            <CoverParticle />
            <AvatarService />
            <div className="min-h-screen flex items-center justify-center py-7 md:py-0 mb-8 xl:mb-0">
                <div className="grid h-full max-w-5xl gap-6 mx-auto md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-2  md:items-center lg:pb-50 pt-45 xl:p-0 ">
                    <div className="max-w-[450px] mx-auto xl:mx-0">
                        ...
                        <div className="flex justify-center xl:justify-start xl:pl-5 ">
                            <Link
                                href="contacto"
                                className="bg-darkBg text-violet-700 px-3 py-2 transition-all border-2 border-violet-700 text-md w-fit rounded-3xl hover:shadow-xl hover:shadow-violet-700"
